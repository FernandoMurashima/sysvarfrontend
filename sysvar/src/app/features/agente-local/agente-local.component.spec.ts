...
describe('AgenteLocalComponent', () => {
  ...
  it('gera e exibe codigo e validade', () => {
    service.gerarCodigoAtivacao.and.returnValue(of({ codigo: 'ABCD-EFGH-IJKL', expira_em: '2026-09-03T12:15:00Z', empresa: 1 }));
  ...
  it('trata erro 403 com mensagem de permissao', () => {
    service.gerarCodigoAtivacao.and.returnValue(throwError(() => ({ status: 403 })));
  ...
  it('trata erro de backend com mensagem amigavel', () => {
    service.gerarCodigoAtivacao.and.returnValue(throwError(() => ({ status: 500 })));
