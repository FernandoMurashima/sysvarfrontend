...
export class ProdutosService {
  ...
  list(params?: { search?: string; ordering?: string; page?: number; page_size?: number; ativo?: 'all' | 'true' | 'false'; tipo_produto?: '1' | '2' | '3' | '4' | string }): Observable<Produto[] | Paginated<Produto>> {
