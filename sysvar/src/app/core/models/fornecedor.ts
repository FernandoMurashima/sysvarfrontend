export interface Fornecedor {
  ...
  contribuinte_icms_descricao?: string | null;
  site?: string | null;
  prazo_padrao_pagamento?: number | null;
  prazo_padrao_pagamento_ref?: number | null;
  prazo_padrao_codigo?: string | null;
  prazo_padrao_descricao?: string | null;
  observacoes_comerciais?: string | null;
  conta_contabil?: string | null;
  conta_contabil_padrao?: number | null;
  conta_contabil_codigo?: string | null;
  conta_contabil_descricao?: string | null;
  natureza_padrao?: number | null;
  natureza_padrao_codigo?: string | null;
  natureza_padrao_descricao?: string | null;
  banco?: string | null;
  agencia?: string | null;
  conta?: string | null;
  tipo_conta?: string | null;
  tipo_conta_descricao?: string | null;
